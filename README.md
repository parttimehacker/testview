...
The TestView class is used respond to the MQTT topic: **diy/system/test**. This class is one of five general classes in my *do it yourself home automation system* (**DIYHA**). Each python DIYHA application is hosted on a Raspberry Pi server and will respond to a **diy/system/test** subscribed topic and report on their status or application specific test data. 
